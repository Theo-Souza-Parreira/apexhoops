...
export function useAutenticacao(){
  ...
  const autenticacaoContexto = useContext(AuthContext)
  ...
  const { emailUsuario, autenticar, sair } = autenticacaoContexto
  ...
  return {criarAutenticacaoUsuario, validarUsuario, deslogar, emailUsuario, autenticar, sair}
}
